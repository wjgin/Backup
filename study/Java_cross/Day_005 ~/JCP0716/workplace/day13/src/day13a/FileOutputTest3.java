...
// 표준 입출력 반복문 테스트
// 표준 입력 -> 프로그램 -> 파일 시스템 출력(바탕화면의  test.txt)
public class FileOutputTest3 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			FileOutputStream fos = new FileOutputStream("D:\\바탕화면\\test.txt");
			// FileNotFoundException 처리가 필요
			//  ㄴ IOException의 하위(sub) 클래스이기에 대체 가능
