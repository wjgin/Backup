...
-- 로그인 sql
-- 올바른 정보 : not null
select * from customer where email = 'seri@daum.net' and password = '1111';
-- 잘못된 정보 : null
select * from customer where email = 'kingdong@naver.com' and password = '11';
-- 없는 사용자 : null
select * from customer where email = 'kingdong@gmain.com' and password = 'qlalfwjsgh';
