...
public class SelectCategoryGui extends javax.swing.JFrame {

	/**
	 * Creates new form TableGui
	 */
	public SelectCategoryGui(String id, String category) {
		initComponents(id, category);
	}

	private void initComponents(String id, String category) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(SelectCategoryGui.class.getName()).log(java.util.logging.Level.SEVERE, null,
					ex);
		...
		rows = dao.getListByCategory(id, category);
