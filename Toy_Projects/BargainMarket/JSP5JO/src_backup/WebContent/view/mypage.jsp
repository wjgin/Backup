...
<div class="mypage">
		<p><span><i class="far fa-user"></i>&nbsp;<strong>${sessionScope.user.name}(${sessionScope.user.email})</strong> 님의 Mypage</span><span class="pronum"><strong>나의 전문가번호</strong> : ${userProInfo.proIdx}(${userProInfo.name})</span></p>
		<div class="mlist_con">
